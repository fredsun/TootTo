...
import org.tootto.R;
import org.tootto.adapter.ImagePagerAdapter;
import org.tootto.fragment.ViewMediaFragment;
import org.tootto.ui.view.ImageViewPager;
...
public class ViewMediaActivity extends BaseActivity implements ViewMediaFragment.PhotoActionsListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        for (int i = 0; i < menu.size(); i++) {
            ...
            if (drawable != null) {
                drawable.mutate();
                int color = ContextCompat.getColor(this, R.color.colorShineWhite);
    ...
    protected void setStatusBar() {
        mStatusBarColor = getResources().getColor(R.color.text_black);
